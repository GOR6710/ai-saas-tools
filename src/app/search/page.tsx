...
export default function Search() {
  ...
  useEffect(() => { setResults(searchTools(query)) }, [query])
    ...
    <main className="py-16">
      <div className="container-main">
        ...
        <div className="max-w-2xl mx-auto mb-10">
          <input type="text" placeholder="输入工具名称、功能或分类..." value={query} onChange={(e) => setQuery(e.target.value)}
        ...
        {results.length === 0 && query && (
          <div className="text-center py-10"><p className="text-slate-500">没有找到匹配的工具，试试其他关键词？</p></div>
        )}
      </div>
    </main>
  )
