...
export const tools: Tool[] = [
  {
    ...
    category: "AI对话", categorySlug: "ai-chat", pricing: "Freemium",
    rating: 4.5, reviewCount: 1280, hasFreeTier: true,
    affiliateUrl: "https://chat.openai.com",
    features: ["自然语言对话", "代码生成", "文本写作", "多语言支持", "网页浏览"],
    pros: ["免费版功能丰富", "响应速度快", "多模态支持"],
    cons: ["中文表现一般", "偶尔有知识幻觉"],
    bestFor: ["日常问答", "内容写作", "编程辅助", "学习辅导"],
  ...
  },
  {
    ...
    category: "AI对话", categorySlug: "ai-chat", pricing: "Freemium",
    rating: 4.7, reviewCount: 680, hasFreeTier: true,
    affiliateUrl: "https://claude.ai",
    features: ["长文本处理", "代码分析", "文档总结", "推理能力", "多模态"],
    pros: ["上下文窗口超长", "推理能力强", "中文表现优秀"],
    cons: ["免费版限制严格", "无联网功能"],
    bestFor: ["长文档分析", "代码审查", "学术研究", "复杂推理"],
  ...
  },
  {
    ...
    category: "AI图像", categorySlug: "ai-image", pricing: "Paid",
    rating: 4.6, reviewCount: 950, hasFreeTier: false,
    affiliateUrl: "https://www.midjourney.com",
    features: ["文本生成图像", "图像放大", "图像变体", "风格迁移", "参数控制"],
    pros: ["艺术风格独特", "图像质量极高", "社区活跃"],
    cons: ["无免费版", "Discord操作门槛高", "中文提示词效果一般"],
    bestFor: ["概念设计", "插画创作", "视觉营销", "艺术创作"],
    alternatives: ["dalle3", "stable-diffusion", "leonardo"],
    pricingPlans: [
  ...
  },
  {
    ...
    category: "AI编程", categorySlug: "ai-coding", pricing: "Freemium",
    rating: 4.8, reviewCount: 520, hasFreeTier: true,
    affiliateUrl: "https://cursor.sh",
    features: ["AI代码补全", "代码重构", "代码解释", "自动生成", "多文件编辑"],
    pros: ["基于VS Code", "AI功能深度集成", "响应速度快"],
    cons: ["收费较贵", "偶尔生成错误代码"],
    bestFor: ["软件开发", "代码审查", "快速原型", "学习编程"],
  ...
  },
  {
    ...
    category: "项目管理", categorySlug: "project-management", pricing: "Freemium",
    rating: 4.4, reviewCount: 2100, hasFreeTier: true,
    affiliateUrl: "https://www.notion.so",
    features: ["笔记管理", "数据库", "AI写作", "团队协作", "看板视图"],
    pros: ["功能全面", "模板丰富", "跨平台同步"],
    cons: ["学习曲线陡峭", "加载速度一般"],
    bestFor: ["知识管理", "团队协作", "项目管理", "个人笔记"],
    alternatives: ["clickup", "obsidian", "asana"],
    pricingPlans: [
